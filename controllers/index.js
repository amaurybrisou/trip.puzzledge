  ...
  fs.readdir(articles, function(err, files) {
    if (err) {
      ...
      for (var i = 0; i < files.length; i++) {
        ...
        parsed.author = parsed.author || config.author
        parsed.description = parsed.description || config.description
        parsed.categories = parsed.categories || config.categories
